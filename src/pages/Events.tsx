...
export const Events: React.FC = () => {
  ...
  const Compartir =(x: IEvent) =>{
    SocialSharing.share(`${x.Name} - ${x.Route} - ${x.Level}`,x.Name,x.FlayerBase)
  }
            ...
            <div key={indx} className="wrapper  antialiased text-gray-900">
              <div>
                ...
                <div className="relative px-4 -mt-16  ">
                  <div className={`bg-[#FFDFD3] p-3 rounded-lg shadow-lg`} >
                    ...
                    <div className="flex gap-4">
                      ...
                      <button onClick={()=>{Compartir(x)}} className="text-[30px] justify-end text-end flex text-custom-primary"><IonIcon aria-hidden="true" icon={shareOutline} /></button>
                    </div>
                  </div>
                </div>
              </div>
